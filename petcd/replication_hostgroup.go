...
func SyncRhgToProxy(etcdcli *etcd.EtcdCli, cli *clientv3.Client) error {
...
func CreateOneRhg(etcdcli *etcd.EtcdCli) error {
...
func UpdateOneRhg(etcdcli *etcd.EtcdCli) error {
...
func DeleteOneRhg(etcdcli *etcd.EtcdCli) error {
