...
func SyncServerToProxy(etcdcli *EtcdCli, cli *clientv3.Client) error {
...
func CreateOneServer(etcdcli *EtcdCli) error {
...
func UpdateOneServer(etcdcli *EtcdCli) error {
...
func DeleteOneServer(etcdcli *EtcdCli) error {
